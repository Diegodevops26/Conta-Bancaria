...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        this.getListarContas();

    }

    private void getListarContas() {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Gerenciar Conta");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnCadastrarConta, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addComponent(cbContas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnCadastrarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarContaActionPerformed
        ...
        this.Contas.add(new Conta(this, ++this.NumConta));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      if (this.Contas.size() > 0) {
            new FoGerenciarConta(
                    this.Contas.get(cbContas.getSelectedIndex()), 
                    this.Contas).setVisible(true);     
        }
        else
            JOptionPane.showMessageDialog(this, "Não existe conta cadastrada");
